...
RSpec.describe EventCandidatesForm do
  ...
  it "accepts two to ten distinct future instants" do
  ...
  it "rejects fewer than two or more than ten instants" do
    expect(described_class.new(instants: [ future_times.first ])).not_to be_valid
